...
class Command(BaseCommand):
    ...
    help = 'Import from V1'
    valid_args = ['User', 'Channel', 'Theme', 'Type', 'Discipline', 'FlatPage','Notes',
    ...
    def add_encodings_to_video(self, video_id, list_encodings):
        try:
            ...
            for enc in list_encodings:
                if enc['eformat'] == 'video/mp4' and (enc['etype']=='240' or enc['etype']=='360' or enc['etype']=='480'or  enc['etype']=='720' or enc['etype']=='1080'):
                    name=enc['etype']+"p"
                    ...
                    if source_url != "":
                        dest_file = os.path.join( settings.MEDIA_ROOT,'videos',video.owner.owner.hashkey,video_id,os.path.basename(videofilenameMp4)) #ajout video_id
                    print(source_url)
                    print(dest_file)
